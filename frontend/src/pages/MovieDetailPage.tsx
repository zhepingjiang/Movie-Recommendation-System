...
/**
 * Movie detail page for route `/movie/:id`: shows full movie info plus a content-based
 * "similar movies" row (see ContentBasedRecommendationService on the backend), independent
 * of any user -- purely a function of this movie's own description/genres.
 */
export default function MovieDetailPage() {
  ...
  if (movie === undefined) {
    return (
      <div className="py-24 text-center text-sm text-[#999]">Loading…</div>
    );
  }
    ...
    <div className="mx-auto w-full max-w-[1400px] px-[60px] py-10 pb-[60px]">
      <div className="flex flex-col gap-10 md:flex-row">
        ...
        <div className="flex-1">
          <div className="mb-3 text-[40px] leading-[1.15] font-bold">
            {movie.title}
          </div>
